...
const ProjectCard = ({ project }) => (
  <Card className="group bg-brand-surface border border-brand-border overflow-hidden transition-[transform,box-shadow,border-color] duration-300 ease-in-out hover:border-brand-primary hover:-translate-y-[5px] hover:shadow-xl hover:shadow-brand-primary/20">
...
const GithubRepoCard = ({ repo }) => (
  <Card className="bg-brand-surface border border-brand-border transition-[transform,box-shadow,border-color] duration-300 ease-in-out hover:border-brand-primary hover:-translate-y-[3px] hover:shadow-lg hover:shadow-brand-primary/15">
    <CardContent className="p-6">
