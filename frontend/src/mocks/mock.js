...
export const personalInfo = {
    ...
    bio: "Apasionado por el desarrollo de software y la resolución de problemas. Combino una gran capacidad de autoaprendizaje con el disfrute por el trabajo bien hecho, buscando siempre construir aplicaciones que realmente aporten valor.",
    description: "Estudiante de Ingeniería Civil Informática con enfoque en el desarrollo de software multiplataforma. Poseo conocimientos sólidos en desarrollo web (Laravel, React) y desarrollo móvil nativo para Android utilizando Kotlin. Busco una práctica profesional donde pueda aportar mi versatilidad técnica para crear soluciones digitales completas y seguir mejorando.",
...
export const skills = {
    "Desarrollo Móvil": [
      { name: "Android Nativo (Kotlin)", level: 85 },
      { name: "Android Studio", level: 85 }
    ],
    "Desarrollo Web": [
      { name: "Laravel", level: 80 },
      { name: "Frontend React (JavaScript)", level: 75 },
      { name: "HTML5", level: 90 },
      { name: "CSS3", level: 85 }
    ],
    "Base de Datos & Herramientas": [
      ...
      { name: "Postman (Consumo de APIs)", level: 75 }
    ]
};
